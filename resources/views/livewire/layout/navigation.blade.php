        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-menu-item class="w-full text-start" title="profile" :href="route('profile')" wire:navigate/>
                <x-menu-item class="w-full text-start" title="history" :href="route('history')" wire:navigate/>
                <x-menu-separator />

                <x-menu-item wire:click="logout" class="w-full text-start" title="logout"/>
                </x-dropdown>
            </div>
