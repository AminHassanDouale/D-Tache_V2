                    ...
                    <td style="width: 596px; vertical-align: middle;" width="596">
                        ...
                        <p
                            ...
                            D-Tache Notification, <a class="link" style="text-decoration: underline;" target="_blank"
                                href="{{ route('tasks.index') }}"><u>Click here</u></a> à voir dans le site D-Taches
                        </p>
                ...
                <tr>
                    <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;"
                        ...
                        <h1
                            ...
                            Salam Aleikoum, {{ $assignee->fullname }}</h1>
                        ...
                        <p
                            ...
                            Veuillez recevoir cet email comme notification de la tâche intitulé "{{ $task->name }}", Cree par {{ $creator->fullname }} et appartient au Projet <span class="text-underline">{{ $project->name }}</span>.
                            Merci
